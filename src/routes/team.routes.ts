...
router.get('/club/:id', teamController.getDetail);
...
router.get('/team/:id/stats', teamController.getStatistics);
...
router.get('/team/:id/suspensions', teamController.getSuspensions);
